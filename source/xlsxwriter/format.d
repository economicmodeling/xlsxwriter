...
enum LXW_PROPERTY_UNSET             = -1;
enum LXW_COLOR_UNSET                = -1;
enum LXW_COLOR_MASK                 = 0xFFFFFF;
enum LXW_MIN_FONT_SIZE              = 1;
enum LXW_MAX_FONT_SIZE              = 409;
...
mixin(standaloneEnums!lxw_format_underlines);
...
mixin(standaloneEnums!lxw_format_scripts);
...
mixin(standaloneEnums!lxw_format_alignments);
...
mixin(standaloneEnums!lxw_format_diagonal_types);
...
enum lxw_defined_colors {
    ...
    /** Pink */
    //LXW_COLOR_PINK = 0xFF00FF, // Same as MAGENTA, this causes problems
...
mixin(standaloneEnums!lxw_defined_colors);
enum LXW_COLOR_PINK = lxw_defined_colors.LXW_COLOR_MAGENTA;
...
mixin(standaloneEnums!lxw_format_patterns);
...
mixin(standaloneEnums!lxw_format_borders);
...
struct lxw_font {
    ...
    char[LXW_FORMAT_FIELD_LEN] font_name;
    uint16_t font_size;
    uint8_t bold;
    uint8_t italic;
